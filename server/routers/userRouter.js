...
router.get('/title',function(req,res){
    ...
    var stmt = 'select title_text  from titleTiping where info_id = \''+data.id+'\'';
...
router.post('/editinfo',function(req,res){    
    ...
    var data = req.body;    
    var resultJson = {};    
    var stmt = 'update infomation set info_littlement = "'+data.form.info_littlement+'",info_name="'+data.form.info_name+'",info_eng_name="'+data.form.info_eng_name+'",info_nickname="'+data.form.info_nickname+'",info_email="'+data.form.info_email+'",info_phone="'+data.form.info_phone+'",info_git="'+data.form.info_git+'" where info_id = "'+data.id+'"';
